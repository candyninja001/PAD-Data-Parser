...
##            print('-----------\n\n')
    ...
    if 'card' in d:
        ...
        for card_data in cards_data['card']:
            ...
            card['devo_materials'] = [card_data[t] for t in range(46,51) if card_data[t] != 0] # mats to devolve
            ...
            card['group'] = 0
            card['types'].extend([3] if -1 != -1 else []) # add type 3, where [3] is [card_data[index]]
            ...
            card['limitbreak_stat_increase'] = 0 # percentage increase, where 0 is card_data[index], same index as last
